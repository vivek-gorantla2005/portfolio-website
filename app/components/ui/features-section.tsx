    ...
    <div className="relative flex py-8 px-2 gap-10 h-full">
      <div className="w-full  p-5  mx-auto bg-white dark:bg-neutral-900 shadow-2xl group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2  ">
          <video src="/project1.mp4" autoPlay muted loop controls></video>
        </div>
      </div>
  ...
  return (
    <div className="w-full  mx-auto bg-transparent dark:bg-transparent group h-full">
      <div className="flex flex-1 w-full h-full flex-col space-y-2  relative">
        {/* TODO */}
        <video src="/project2.mp4" autoPlay muted loop controls></video>
      </div>
    </div>
  );
};
...
export const SkeletonFour = () => {
  return (
    <div className="h-full md:h-60  flex flex-col items-center relative bg-transparent dark:bg-transparent mt-10">
